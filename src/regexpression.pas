{
    $Id: regexpression.pas,v 1.1 2004/08/05 13:52:28 ograf Exp $
...
{
  $Log: regexpression.pas,v $
  Revision 1.1  2004/08/05 13:52:28  ograf
  fixed Makefiles
  fixed regex search
  simplified ThirdLevel ffilter check
  fixed subword info byte initialisation

  Revision 1.1  2002/08/29 15:14:16  ograf
  moved all pas to josrc for easier maintainance

  Revision 1.2  2002/08/29 13:23:01  ograf
